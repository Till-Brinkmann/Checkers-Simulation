...
public class NNPlayer2 implements Player{
	...
	private NN nn;
	private String name = "standard NNPlayer2";
	public NNPlayer2(GameLogic gmlc, Console console) {
		this.gmlc = gmlc;
	...
	private void setNN() {
		if(nn == null) {
			console.printInfo("No NN file was found in the NNPlayer folder. Game will be cancelled.","NNPlayer");
			//TODO game has to be canceled			
		}
	    ...
	    int hiddenLayer = 0;
		try {
			File directory = new File("resources/NNPlayer2Info");
			String[] files = directory.list();
			File file = new File("resources/NNPlayer2Info/" + files[0]);
