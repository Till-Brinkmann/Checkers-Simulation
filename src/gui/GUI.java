...
import checkers.Game.Situations;
...
public class GUI extends JFrame{
	...
	private void initialize(){
		...
		console = new Console();
		playfieldpanel = new PlayfieldPanel(gameManager ,console);
        ...
        loadgame.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent event)
            {
            	...
            	if(rueckgabeWert == JFileChooser.APPROVE_OPTION){
		        	...
		        	try {
		        		if(gamesettings.getGameManager() != null) {
						    gamesettings.getGameManager().getGame().getPlayfield().loadGameSituation(file);
...
//            	else{
        ...
        savegame.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent event)
            {
            	try {
            		if(gamesettings.getGameManager() != null) {
            			gamesettings.getGameManager().getGame().getPlayfield().saveGameSituation();
            		}
        ...
        slow.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent event)
            {
            	if(slow.isSelected()) {
            		...
            		fast.updateUI();
            		gamesettings.getGameManager().getGame().setSlowness(2000);
            	}
            }
        });
        medium.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent event)
            {
            	if(medium.isSelected()) {
            		...
            		fast.setSelected(false);
            		gamesettings.getGameManager().getGame().setSlowness(1000);
            	}
            }
        });
        fast.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent event)
            {
            	if(fast.isSelected()) {
            		...
            		gamesettings.getGameManager().getGame().setSlowness(0);
            	}
            }
        });
        resume.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent event)
            {
            	...
            	gamesettings.getGameManager().getGame().setPause(false);
            }
        });
        pause.addActionListener(new ActionListener()
        {
            ...
            {          	
            	...
            	gamesettings.getGameManager().getGame().setPause(true);
            }
        });
        stop.addActionListener(new ActionListener()
        {
            ...
            {
            	stop.setEnabled(false);
            	gamesettings.getGameManager().getGame().finishGameTest(Situations.STOP,false);
            }
        });
