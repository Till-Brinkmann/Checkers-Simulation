...
public class NN
{
    ...
    public void changeAllPercent(double quality){ //in percent
        for (int i = 0; i < afterInputWeights.length; i++){
            for (int x = 0; x < afterInputWeights[0].length; x++){
                afterInputWeights[i][x] *= Math.random() < 0.9 ? (1 + (Math.random() - 0.5) * 2 * quality / 100) : -(1 + (Math.random() - 0.5) * 2 * quality / 100);
            }
        }
        for (int i = 0; i < hiddenWeights.length; i++){
            for (int x = 0; x < hiddenWeights[0].length; x++){
                for (int y = 0; y < hiddenWeights[0][0].length; y++){
                    hiddenWeights[i][x][y] *= Math.random() < 0.9 ? (1 + (Math.random() - 0.5) * 2 * quality / 100) : -(1 + (Math.random() - 0.5) * 2 * quality / 100);
                }
            }
        }
        for (int i = 0; i < toOutputWeights.length; i++){
            for (int x = 0; x < toOutputWeights[0].length; x++){
                toOutputWeights[i][x] *= Math.random() < 0.9 ? (1 + (Math.random() - 0.5) * 2 * quality / 100) : -(1 + (Math.random() - 0.5) * 2 * quality / 100);
            }
        }
    }
    ...
    public void changeAllReal(double quality){ //real
        for (int i = 0; i < afterInputWeights.length; i++){
            for (int x = 0; x < afterInputWeights[0].length; x++){
                afterInputWeights[i][x] += Math.random() < 0.9 ? (Math.random() - 0.5) * 2 * quality / 100 : -((Math.random() - 0.5) * 2 * quality / 100);
            }
        }
        for (int i = 0; i < hiddenWeights.length; i++){
            for (int x = 0; x < hiddenWeights[0].length; x++){
                for (int y = 0; y < hiddenWeights[0][0].length; y++){
                    hiddenWeights[i][x][y] += Math.random() < 0.9 ? (Math.random() - 0.5) * 2 * quality / 100 : -((Math.random() - 0.5) * 2 * quality / 100);
                }
            }
        }
        for (int i = 0; i < toOutputWeights.length; i++){
            for (int x = 0; x < toOutputWeights[0].length; x++){
                toOutputWeights[i][x] += Math.random() < 0.9 ? (Math.random() - 0.5) * 2 * quality / 100 : -((Math.random() - 0.5) * 2 * quality / 100);
            }
        }
    }   
