...
public class Move implements Serializable {
	...
	/**
	 * If the move is invalid, the method returns null.
	 *<p>
	 * @return an one-dimensional array with the length of 2 that represents the coords on which the figure finishes his move.
	 */
	 ...
	 * @return
	 */
	public static int[] fieldToCoords(int choiceField) {
		int[] c = new int[2];
        c[0] = choiceField%4;
	 ...
	 * @return
	 */
	public static byte coordsToField(int x, int y){
		if(y%2 == 1){
        	x--;
        }
		x /= 2;
